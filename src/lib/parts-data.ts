...
export const GPU_OPTIONS: ComparableOption[] = [
  {
    ...
    salesNote: "Emphasize CUDA acceleration value for video pros.",
  ...
  },
  {
    ...
    stock: "Ready",
    compatible: true,
    reason: "Best value if the customer doesn't need max 4K FPS",
    salesNote: "Upsell path: bundle with 1440p monitor for higher attach rate.",
  ...
  },
  {
    ...
    salesNote: "Requires 1000W PSU upgrade — check cart for compatible PSU.",
    beginnerNote: "Overkill for most. Only suggest if budget is flexible.",
    tag: "alt",
  },
];
...
export const CPU_OPTIONS: ComparableOption[] = [
  {
    ...
    salesNote: "Pair with $30 air cooler — keeps margin healthy.",
  ...
  },
  {
    ...
    salesNote: "Emphasize 24 cores for Premiere/DaVinci exports.",
  ...
  },
  {
    ...
    salesNote: "Only suggest if customer wants AMD platform — needs board change.",
...
export const CPU_METRICS: Metric[] = [
  ...
  },
  {
    ...
    label: "Stock",
    dir: "neutral",
    hint: "In-store availability today.",
...
export const GPU_METRICS: Metric[] = [
  {
    ...
    label: "Price",
    dir: "lower",
    hint: "Lower price is better for the customer's budget.",
    value: (o) => o.price,
    format: (o) => `$${o.price.toLocaleString()}`,
  },
  {
